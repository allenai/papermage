...
class SpanQAPredictor(BasePredictor):
    ...
    def _predict(self, doc: Document) -> List[Annotation]:
        ...
        user_selected_span[0].metadata["retrieved_evidence"] = [
            ev.dict()
            for ev in paper_snippet.qae[0].evidence
        ]
